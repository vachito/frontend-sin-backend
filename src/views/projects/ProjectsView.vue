...
<template>
  <div class="flex flex-col sm:flex-row justify-between items-center bg-sidebar p-2 rounded-lg border shadow-xs">
  ...
  <div class=" bg-sidebar p-2 mt-4 min-h-[100vh] rounded-lg border shadow-sm">
    <div class="mt-5 flex items-center gap-1">
      <Input id="bucarp" class="max-w-sm bg-background" placeholder="Buscar proyecto..." v-model="searchProject" />
      <Label for="bucarp">
        <Search />
      </Label>
    </div>
